    ...
    return (
      ...
      <div className="row">
        ...
        <div className="jumbotron shadow-lg  p-3 mb-5">
            ...
            9 &#60;You will <span className="yellow">become</span> an <span className="lightBlue">integral</span> part in both the <br></br>10 <span className="purple">enrichment</span> and the <span className="purple">growth</span> of <span className="developer">developers</span> everywhere/&#62;;<br></br>11 <br></br>12 &#125;;</h6>
        </div>
      </div>
    </div>
